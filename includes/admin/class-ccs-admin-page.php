...
class CCS_Admin_Page {
	...
	public function render() {
		...
		if ( isset( $_POST['submit'] ) && check_admin_referer( 'ccs_settings_nonce', 'ccs_settings_nonce' ) ) {
			$catalog_token = isset( $_POST['ccs_catalog_token'] ) ? sanitize_text_field( wp_unslash( $_POST['ccs_catalog_token'] ) ) : '';
			$catalog_url   = isset( $_POST['ccs_catalog_url'] ) ? esc_url_raw( wp_unslash( $_POST['ccs_catalog_url'] ) ) : '';

			update_option( 'ccs_catalog_token', $catalog_token );
		...
		<div class="wrap">
			...
			<div class="ccs-admin-container">
						...
						<table class="form-table">
							<tr id="ccs_catalog_url_row">
								...
								<td>
									...
									<p class="description">
										<?php _e( 'Your Canvas Catalog URL.', 'canvas-course-sync' ); ?>
									</p>
								</td>
							</tr>
							<tr>
								<th scope="row">
									<label for="ccs_catalog_token"><?php _e( 'Catalog Token', 'canvas-course-sync' ); ?></label>
								</th>
								<td>
									<input type="password" name="ccs_catalog_token" id="ccs_catalog_token" class="regular-text"
											value="<?php echo esc_attr( get_option( 'ccs_catalog_token' ) ); ?>" />
									<p class="description">
										<?php _e( 'Your Catalog API token. ', 'canvas-course-sync' ); ?>
									</p>
								</td>
							</tr>
						</table>
				...
				<div class="ccs-panel ccs-debug-panel">
					...
					<p><strong>Catalog Token:</strong> <?php echo get_option( 'ccs_catalog_token' ) ? 'Set' : 'Not set'; ?></p>
