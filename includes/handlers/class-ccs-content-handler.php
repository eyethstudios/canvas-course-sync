...
class CCS_Content_Handler {
    ...
    private function build_badge_information($course_details) {
        ...
        if ($badge_info) {
            ...
            $badge_image_url = plugins_url('assets/images/' . $badge_info['image_file'], dirname(dirname(__FILE__)));
            ...
            $badge_image_url = plugins_url('assets/images/ndc-badge.svg', dirname(dirname(__FILE__)));
            $content .= "<div class='badge-image' style='text-align: center; margin: 20px 0;'>\n";
